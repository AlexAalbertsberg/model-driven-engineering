...
public class ActionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ActionPackage.ACTION: {
				...
				if (result == null) result = caseLocatedElement(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.START: {
				Start start = (Start)theEObject;
				T result = caseStart(start);
				if (result == null) result = caseAction(start);
				if (result == null) result = caseLocatedElement(start);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.STOP: {
				Stop stop = (Stop)theEObject;
				T result = caseStop(stop);
				if (result == null) result = caseAction(stop);
				if (result == null) result = caseLocatedElement(stop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.VARIABLE_DECL: {
				VariableDecl variableDecl = (VariableDecl)theEObject;
				T result = caseVariableDecl(variableDecl);
				if (result == null) result = caseAction(variableDecl);
				if (result == null) result = caseLocatedElement(variableDecl);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ActionPackage.CONDITION: {
				Condition condition = (Condition)theEObject;
				T result = caseCondition(condition);
				if (result == null) result = caseAction(condition);
				if (result == null) result = caseLocatedElement(condition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.INTEGER_EXP: {
				IntegerExp integerExp = (IntegerExp)theEObject;
				T result = caseIntegerExp(integerExp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.INT_OPERAND: {
				IntOperand intOperand = (IntOperand)theEObject;
				T result = caseIntOperand(intOperand);
				if (result == null) result = caseIntegerExp(intOperand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.CONSTANT: {
				Constant constant = (Constant)theEObject;
				T result = caseConstant(constant);
				if (result == null) result = caseIntOperand(constant);
				if (result == null) result = caseIntegerExp(constant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = caseIntOperand(variable);
				if (result == null) result = caseIntegerExp(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.OPERATION_PLUS: {
				OperationPlus operationPlus = (OperationPlus)theEObject;
				T result = caseOperationPlus(operationPlus);
				if (result == null) result = caseIntegerExp(operationPlus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.BOOLEAN_EXP: {
				BooleanExp booleanExp = (BooleanExp)theEObject;
				T result = caseBooleanExp(booleanExp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionPackage.LESS_EXP: {
				LessExp lessExp = (LessExp)theEObject;
				T result = caseLessExp(lessExp);
				if (result == null) result = caseBooleanExp(lessExp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Operation Plus</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Operation Plus</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOperationPlus(OperationPlus object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Less Exp</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Less Exp</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLessExp(LessExp object) {
		return null;
	}
