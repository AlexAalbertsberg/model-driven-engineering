...
/**
 * This is the item provider adapter for a {@link school.Query} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Query_student_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Query_student_feature", "_UI_Query_type"),
				 SchoolPackage.Literals.QUERY__STUDENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addWherePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Query_where_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Query_where_feature", "_UI_Query_type"),
				 SchoolPackage.Literals.QUERY__WHERE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SchoolPackage.Literals.QUERY__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchoolPackage.Literals.QUERY__WHERE);
		}
	...
	public String getText(Object object) {
		SchoolElement labelValue = ((Query)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Query.class)) {
			case SchoolPackage.QUERY__TYPE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SchoolPackage.QUERY__WHERE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchoolPackage.Literals.QUERY__WHERE,
				 SchoolFactory.eINSTANCE.createWhere()));
	}
