...
public class TeacherItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTeachesPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Teaches feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTeachesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Teacher_teaches_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Teacher_teaches_feature", "_UI_Teacher_type"),
				 SchoolPackage.Literals.TEACHER__TEACHES,
				 true,
				 false,
				 true,
				 null,
