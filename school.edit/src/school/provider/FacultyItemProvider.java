...
/**
 * This is the item provider adapter for a {@link school.Faculty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Faculty_courseofstudy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Faculty_courseofstudy_feature", "_UI_Faculty_type"),
				 SchoolPackage.Literals.FACULTY__COURSEOFSTUDY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SchoolPackage.Literals.FACULTY__NAME,
				 true,
				 false,
				 false,
