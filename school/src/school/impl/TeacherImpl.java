 ...
 * </p>
 * <ul>
 *   <li>{@link school.impl.TeacherImpl#getTeaches <em>Teaches</em>}</li>
...
public class TeacherImpl extends MinimalEObjectImpl.Container implements Teacher {
	...
	public EList<Course> getTeaches() {
		if (teaches == null) {
			teaches = new EObjectWithInverseResolvingEList<Course>(Course.class, this, SchoolPackage.TEACHER__TEACHES, SchoolPackage.COURSE__TAUGHT_BY);
		}
		return teaches;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SchoolPackage.TEACHER__TEACHES:
