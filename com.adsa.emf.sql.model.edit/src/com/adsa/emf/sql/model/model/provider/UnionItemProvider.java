...
/**
 * This is the item provider adapter for a {@link com.adsa.emf.sql.model.model.Union} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Union_select_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Union_select_feature", "_UI_Union_type"),
				 ModelPackage.Literals.UNION__SELECT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.UNION__SELECT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Union.class)) {
			case ModelPackage.UNION__SELECT:
