...
/**
 * This is the item provider adapter for a {@link com.adsa.emf.sql.model.model.NotExists} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NotExistsItemProvider 
	 ...
	 * @generated
	 */
	public NotExistsItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSelectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Existence_select_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Existence_select_feature", "_UI_Existence_type"),
				 ModelPackage.Literals.EXISTENCE__SELECT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.EXISTENCE__SELECT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NotExists"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_NotExists_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NotExists.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.EXISTENCE__SELECT,
				 ModelFactory.eINSTANCE.createSelect()));
	}
