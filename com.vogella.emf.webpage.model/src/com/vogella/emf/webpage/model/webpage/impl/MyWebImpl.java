 ...
 * </p>
 * <ul>
 *   <li>{@link com.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link com.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link com.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getPages <em>Pages</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MyWebImpl extends MinimalEObjectImpl.Container implements MyWeb {
	...
	public EList<Webpage> getPages() {
		if (pages == null) {
			pages = new EObjectResolvingEList<Webpage>(Webpage.class, this, WebpagePackage.MY_WEB__PAGES);
		}
		return pages;
	}
