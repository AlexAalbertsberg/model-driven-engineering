...
/**
 * This is the item provider adapter for a {@link computer.Processor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessorItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNumCoresPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComputerPackage.Literals.PROCESSOR__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCPU_socketPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_CPU_socket_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_CPU_socket_feature", "_UI_Processor_type"),
				 ComputerPackage.Literals.PROCESSOR__CPU_SOCKET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Num Cores feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumCoresPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_numCores_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_numCores_feature", "_UI_Processor_type"),
				 ComputerPackage.Literals.PROCESSOR__NUM_CORES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addClockSpeedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_clockSpeed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_clockSpeed_feature", "_UI_Processor_type"),
				 ComputerPackage.Literals.PROCESSOR__CLOCK_SPEED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPower_consumptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_power_consumption_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_power_consumption_feature", "_UI_Processor_type"),
				 ComputerPackage.Literals.PROCESSOR__POWER_CONSUMPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
