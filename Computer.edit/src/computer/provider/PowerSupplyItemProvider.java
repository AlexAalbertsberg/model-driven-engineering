...
/**
 * This is the item provider adapter for a {@link computer.PowerSupply} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PowerSupplyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PowerSupply_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PowerSupply_name_feature", "_UI_PowerSupply_type"),
				 ComputerPackage.Literals.POWER_SUPPLY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCapacityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PowerSupply_capacity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PowerSupply_capacity_feature", "_UI_PowerSupply_type"),
				 ComputerPackage.Literals.POWER_SUPPLY__CAPACITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPower_consumptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PowerSupply_power_consumption_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PowerSupply_power_consumption_feature", "_UI_PowerSupply_type"),
				 ComputerPackage.Literals.POWER_SUPPLY__POWER_CONSUMPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
