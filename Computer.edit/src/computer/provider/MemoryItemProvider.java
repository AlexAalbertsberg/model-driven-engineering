...
/**
 * This is the item provider adapter for a {@link computer.Memory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemoryItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMemory_clock_speedPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComputerPackage.Literals.MEMORY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMemory_sizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Memory_memory_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Memory_memory_size_feature", "_UI_Memory_type"),
				 ComputerPackage.Literals.MEMORY__MEMORY_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Memory clock speed feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMemory_clock_speedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Memory_memory_clock_speed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Memory_memory_clock_speed_feature", "_UI_Memory_type"),
				 ComputerPackage.Literals.MEMORY__MEMORY_CLOCK_SPEED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPower_consumptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Memory_power_consumption_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Memory_power_consumption_feature", "_UI_Memory_type"),
				 ComputerPackage.Literals.MEMORY__POWER_CONSUMPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
